...
| Influx of traffic creates a bottleneck for the model | Horizontal scaling, caching |
...
| CI/CD rejects a pull request | if this is related to an active incident, and it is a minor issue (e.g. noisy integration test or formatting), we should allow an override with director approval |